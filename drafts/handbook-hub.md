...
**Hermes Agent is an open-source AI agent by [Nous Research](https://nousresearch.com) that runs on your own machine or a cheap VPS, remembers what it learns across sessions, and writes its own reusable skills as it works. It talks to you through a CLI, Telegram, Discord, email, and many other messaging providers. It hit 233,493 GitHub stars (as of 2026-08-21), and it's the fastest-growing open-source agent of 2026.**
...
The handbook teaches you the fundamentals. The Atlas is where you find the specific tool you need for a specific job, ranked, filtered, and security-reviewed. **[Browse all 231+ projects →](/)**.
...
Hermes self-updates. It tells you what changed, backs up your config, and applies the new version. Current release is v0.20.4 (as of 2026-08-18); the team ships roughly every two weeks.
...
**Last updated:** 2026-08-21 · Version and star figures re-stamp automatically with every site build.

**Cited stats:**
- 233,493 GitHub stars (as of 2026-08-21) — source: `api.github.com/repos/NousResearch/hermes-agent`
- 231+ projects in the Hermes Atlas (as of 2026-08-21)
