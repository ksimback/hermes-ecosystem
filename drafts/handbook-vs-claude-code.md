...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 249,195 stars as of 2026-09-26 |
...
- **You want it to be yours.** MIT-licensed, 249,195 stars (as of 2026-09-26), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Cited stats:**
- 249,195 GitHub stars (as of 2026-09-26) — source: `api.github.com/repos/NousResearch/hermes-agent`
