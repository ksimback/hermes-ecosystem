...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 222,152 stars as of 2026-07-29 |
...
- **You want it to be yours.** MIT-licensed, 222,152 stars (as of 2026-07-29), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Cited stats:**
- 222,152 GitHub stars (as of 2026-07-29) — source: `api.github.com/repos/NousResearch/hermes-agent`
