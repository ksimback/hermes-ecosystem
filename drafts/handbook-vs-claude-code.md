...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 214,844 stars as of 2026-07-14 |
...
- **You want it to be yours.** MIT-licensed, 214,844 stars (as of 2026-07-14), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
- **Want the tool landscape?** Browse **[all 184+ projects in the Atlas →](/)**
...
**Last updated:** 2026-07-14 · Version and star figures re-stamp automatically with every site build.

**Cited stats:**
- 214,844 GitHub stars (as of 2026-07-14) — source: `api.github.com/repos/NousResearch/hermes-agent`
