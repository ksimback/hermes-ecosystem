...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 238,969 stars as of 2026-08-31 |
...
- **You want it to be yours.** MIT-licensed, 238,969 stars (as of 2026-08-31), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
**Cited stats:**
- 238,969 GitHub stars (as of 2026-08-31) — source: `api.github.com/repos/NousResearch/hermes-agent`
