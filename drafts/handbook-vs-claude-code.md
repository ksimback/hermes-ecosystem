...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 221,889 stars as of 2026-07-28 |
...
- **You want it to be yours.** MIT-licensed, 221,889 stars (as of 2026-07-28), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
- **Want the tool landscape?** Browse **[all 218+ projects in the Atlas →](/)**
...
**Last updated:** 2026-07-28 · Version and star figures re-stamp automatically with every site build.

**Cited stats:**
- 221,889 GitHub stars (as of 2026-07-28) — source: `api.github.com/repos/NousResearch/hermes-agent`
