...
> A satellite page of **[The Hermes Handbook](/guide/)**. Cross-checked against both tools' docs and real community usage as of August 2026.
...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 238,082 stars as of 2026-08-29 |
...
- **You want it to be yours.** MIT-licensed, 238,082 stars (as of 2026-08-29), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
- **Want the tool landscape?** Browse **[all 244+ projects in the Atlas →](/)**
