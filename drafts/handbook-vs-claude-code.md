...
> A satellite page of **[The Hermes Handbook](/guide/)**. Cross-checked against both tools' docs and real community usage as of July 2026.
...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 221,908 stars as of 2026-07-29 |
...
- **You want it to be yours.** MIT-licensed, 221,908 stars (as of 2026-07-29), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
- **Want the tool landscape?** Browse **[all 217+ projects in the Atlas →](/)**
...
**Last updated:** 2026-07-29 · Version and star figures re-stamp automatically with every site build.

**Cited stats:**
- 221,908 GitHub stars (as of 2026-07-29) — source: `api.github.com/repos/NousResearch/hermes-agent`
