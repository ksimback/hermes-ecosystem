...
> A satellite page of **[The Hermes Handbook](/guide/)**. Cross-checked against both tools' docs and real community usage as of September 2026.
...
| **License & openness** | Proprietary (Anthropic) | Open-source (MIT), 249,194 stars as of 2026-09-26 |
...
- **You want it to be yours.** MIT-licensed, 249,194 stars (as of 2026-09-26), self-hostable on a $5 VPS. The code is open, the data lives on your disk, and nothing phones home.
...
- **Want the tool landscape?** Browse **[all 248+ projects in the Atlas →](/)**
...
**Last updated:** 2026-09-26 · Version and star figures re-stamp automatically with every site build.

**Cited stats:**
- 249,194 GitHub stars (as of 2026-09-26) — source: `api.github.com/repos/NousResearch/hermes-agent`
