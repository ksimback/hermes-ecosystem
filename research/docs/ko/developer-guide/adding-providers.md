...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/developer-guide/adding-providers
...
See `plugins/model-providers/nvidia/` or `plugins/model-providers/gmi/` as a template, and the full [Model Provider Plugin guide](/docs/ko/docs/developer-guide/model-provider-plugin) for field reference, hook idioms, and end-to-end examples.
...
-   [Architecture](/docs/ko/developer-guide/architecture)
-   [Contributing](/docs/ko/developer-guide/contributing)
