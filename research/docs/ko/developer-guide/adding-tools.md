...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/developer-guide/adding-tools

Before writing a tool, ask yourself: **should this be a [skill](/docs/ko/developer-guide/creating-skills) instead?**
...
-   [Plugins](/docs/ko/docs/user-guide/features/plugins)
-   [Build a Hermes Plugin](/docs/ko/docs/guides/build-a-hermes-plugin)
