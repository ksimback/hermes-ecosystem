...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/developer-guide/architecture
...
2.  **[Agent Loop Internals](/docs/ko/developer-guide/agent-loop)** — how AIAgent works
3.  **[Prompt Assembly](/docs/ko/developer-guide/prompt-assembly)** — system prompt construction
4.  **[Provider Runtime Resolution](/docs/ko/developer-guide/provider-runtime)** — how providers are selected
5.  **[Adding Providers](/docs/ko/developer-guide/adding-providers)** — practical guide to adding a new provider
6.  **[Tools Runtime](/docs/ko/developer-guide/tools-runtime)** — tool registry, dispatch, environments
7.  **[Session Storage](/docs/ko/developer-guide/session-storage)** — SQLite schema, FTS5, session lineage
8.  **[Gateway Internals](/docs/ko/developer-guide/gateway-internals)** — messaging platform gateway
9.  **[Context Compression & Prompt Caching](/docs/ko/developer-guide/context-compression-and-caching)** — compression and caching
10.  **[ACP Internals](/docs/ko/developer-guide/acp-internals)** — IDE integration
...
→ [Agent Loop Internals](/docs/ko/developer-guide/agent-loop)
...
→ [Prompt Assembly](/docs/ko/developer-guide/prompt-assembly), [Context Compression & Prompt Caching](/docs/ko/developer-guide/context-compression-and-caching)
...
→ [Provider Runtime Resolution](/docs/ko/developer-guide/provider-runtime)
...
→ [Tools Runtime](/docs/ko/developer-guide/tools-runtime)
...
→ [Session Storage](/docs/ko/developer-guide/session-storage)
...
→ [Gateway Internals](/docs/ko/developer-guide/gateway-internals)
...
→ [Plugin Guide](/docs/ko/docs/guides/build-a-hermes-plugin), [Memory Provider Plugin](/docs/ko/developer-guide/memory-provider-plugin)
