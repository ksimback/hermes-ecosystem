...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/developer-guide/context-compression-and-caching
...
For building a context engine plugin, see [Context Engine Plugins](/docs/ko/docs/developer-guide/context-engine-plugin).
