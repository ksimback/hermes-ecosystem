...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/developer-guide/context-engine-plugin
...
-   [Context Compression and Caching](/docs/ko/docs/developer-guide/context-compression-and-caching) — how the built-in compressor works
-   [Memory Provider Plugins](/docs/ko/docs/developer-guide/memory-provider-plugin) — analogous single-select plugin system for memory
-   [Plugins](/docs/ko/docs/user-guide/features/plugins) — general plugin system overview
