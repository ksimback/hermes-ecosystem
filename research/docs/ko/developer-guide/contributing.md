...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/developer-guide/contributing
...
5.  **New skills** — broadly useful ones (see [Creating Skills](/docs/ko/developer-guide/creating-skills))
6.  **New tools** — rarely needed; most capabilities should be skills
7.  **Documentation** — fixes, clarifications, new examples

## Common contribution paths

-   Building a custom/local tool without modifying Hermes core? Start with [Build a Hermes Plugin](/docs/ko/guides/build-a-hermes-plugin)
-   Building a new built-in core tool for Hermes itself? Start with [Adding Tools](/docs/ko/developer-guide/adding-tools)
-   Building a new skill? Start with [Creating Skills](/docs/ko/developer-guide/creating-skills)
-   Building a new inference provider? Start with [Adding Providers](/docs/ko/developer-guide/adding-providers)
