...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/developer-guide/gateway-internals
...
-   **Explicit target delivery** — `send_message` tool specifying `telegram:-1001234567890`, or the [`hermes send` CLI](/docs/ko/docs/guides/pipe-script-output) wrapping the same tool for shell scripts
...
-   [Messaging Gateway (User Guide)](/docs/ko/docs/user-guide/messaging)
