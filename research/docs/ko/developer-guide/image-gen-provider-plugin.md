...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/developer-guide/image-gen-provider-plugin
...
Image-gen is one of several **backend plugins** Hermes supports. The others (with more specialized ABCs) are [Memory Provider Plugins](/docs/ko/docs/developer-guide/memory-provider-plugin), [Context Engine Plugins](/docs/ko/docs/developer-guide/context-engine-plugin), and [Model Provider Plugins](/docs/ko/docs/developer-guide/model-provider-plugin). General tool/hook/CLI plugins live in [Build a Hermes Plugin](/docs/ko/docs/guides/build-a-hermes-plugin).
...
`my_backend_imggen_package` must expose a top-level `register` function. See [Distribute via pip](/docs/ko/docs/guides/build-a-hermes-plugin#distribute-via-pip) in the general plugin guide for the full setup.

## Related pages

-   [Image Generation](/docs/ko/docs/user-guide/features/image-generation) — user-facing feature documentation
-   [Plugins overview](/docs/ko/docs/user-guide/features/plugins) — all plugin types at a glance
-   [Build a Hermes Plugin](/docs/ko/docs/guides/build-a-hermes-plugin) — general tools/hooks/slash commands guide
