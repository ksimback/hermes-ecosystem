...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/getting-started/quickstart
...
If you're installing on a phone, see the dedicated [Termux guide](/docs/ko/getting-started/termux) for the tested manual path, supported extras, and current Android-specific limitations.
...
For detailed installation options, prerequisites, and troubleshooting, see the [Installation guide](/docs/ko/getting-started/installation).
...
One subscription covers 300+ models plus the [Tool Gateway](/docs/ko/user-guide/features/tool-gateway) (web search, image generation, TTS, cloud browser). On a fresh install:
...
IAM role or `aws configure` ([guide](/docs/ko/guides/aws-bedrock))
...
For most first-time users: choose a provider, accept the defaults unless you know why you're changing them. The full provider catalog with env vars and setup steps lives on the [Providers](/docs/ko/integrations/providers) page.
...
You can switch providers at any time with `hermes model` — no lock-in. For a full list of all supported providers and setup details, see [AI Providers](/docs/ko/integrations/providers).
...
Hermes ships with two terminal interfaces: the classic `prompt_toolkit` CLI and a newer [TUI](/docs/ko/user-guide/tui) with modal overlays, mouse selection, and non-blocking input. Both share the same sessions, slash commands, and config — try each with `hermes` vs `hermes --tui`.
...
Connect [Telegram](/docs/ko/docs/user-guide/messaging/telegram), [Discord](/docs/ko/docs/user-guide/messaging/discord), [Slack](/docs/ko/docs/user-guide/messaging/slack), [WhatsApp](/docs/ko/docs/user-guide/messaging/whatsapp), [Signal](/docs/ko/docs/user-guide/messaging/signal), [Email](/docs/ko/docs/user-guide/messaging/email), or [Home Assistant](/docs/ko/docs/user-guide/messaging/homeassistant), or [Microsoft Teams](/docs/ko/docs/user-guide/messaging/teams).
...
Then in the CLI: `/voice on`. Press `Ctrl+B` to record. See [Voice Mode](/docs/ko/user-guide/features/voice-mode).
...
See [ACP Editor Integration](/docs/ko/user-guide/features/acp).
...
-   **[CLI Guide](/docs/ko/user-guide/cli)** — Master the terminal interface
-   **[Configuration](/docs/ko/user-guide/configuration)** — Customize your setup
-   **[Messaging Gateway](/docs/ko/user-guide/messaging/)** — Connect Telegram, Discord, Slack, WhatsApp, Signal, Email, Home Assistant, Teams, and more
-   **[Tools & Toolsets](/docs/ko/user-guide/features/tools)** — Explore available capabilities
-   **[AI Providers](/docs/ko/integrations/providers)** — Full provider list and setup details
-   **[Skills System](/docs/ko/user-guide/features/skills)** — Reusable workflows and knowledge
-   **[Tips & Best Practices](/docs/ko/guides/tips)** — Power user tips
