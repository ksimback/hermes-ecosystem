...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/getting-started/updating
...
See [Nix Setup](/docs/ko/getting-started/nix-setup) for more details.
