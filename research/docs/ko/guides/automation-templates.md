...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/guides/automation-templates

Copy-paste recipes for common automation patterns. Each template uses Hermes's built-in [cron scheduler](/docs/ko/docs/user-guide/features/cron) for time-based triggers and [webhook platform](/docs/ko/docs/user-guide/messaging/webhooks) for event-driven triggers.
