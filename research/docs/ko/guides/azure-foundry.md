...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/guides/azure-foundry
...
-   [Environment variables](/docs/ko/docs/reference/environment-variables)
-   [Configuration](/docs/ko/docs/user-guide/configuration)
-   [AWS Bedrock](/docs/ko/docs/guides/aws-bedrock) — the other major cloud provider integration
