...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/guides/cron-script-only
...
See the [cron feature reference](/docs/ko/docs/user-guide/features/cron) for the full syntax.
...
OS cron + `curl` to a [webhook subscription](/docs/ko/docs/user-guide/messaging/webhooks)
...
-   [Automate Anything with Cron](/docs/ko/docs/guides/automate-with-cron) — LLM-driven cron patterns.
-   [Scheduled Tasks (Cron) reference](/docs/ko/docs/user-guide/features/cron) — full schedule syntax, lifecycle, delivery routing.
-   [Webhook Subscriptions](/docs/ko/docs/user-guide/messaging/webhooks) — fire-and-forget HTTP entry points for external schedulers.
-   [Gateway Internals](/docs/ko/docs/developer-guide/gateway-internals) — delivery-router internals.
