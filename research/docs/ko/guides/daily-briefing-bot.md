...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/guides/daily-briefing-bot
...
-   **Messaging configured** (optional but recommended) — [Telegram](/docs/ko/docs/user-guide/messaging/telegram) or Discord set up with a home channel
...
Each sub-agent searches independently and in parallel, then the main agent combines everything into one polished briefing. See the [Delegation docs](/docs/ko/docs/user-guide/features/delegation) for more on how this works.
...
If you have [memory](/docs/ko/docs/user-guide/features/memory) enabled, you can store preferences that persist across sessions. But remember — cron jobs run in fresh sessions without conversational memory. To add personal context, bake it directly into the prompt:
...
-   **[Scheduled Tasks (Cron)](/docs/ko/docs/user-guide/features/cron)** — Full reference for schedule formats, repeat limits, and delivery options
-   **[Delegation](/docs/ko/docs/user-guide/features/delegation)** — Deep dive into parallel sub-agent workflows
-   **[Messaging Platforms](/docs/ko/docs/user-guide/messaging)** — Set up Telegram, Discord, or other delivery targets
-   **[Memory](/docs/ko/docs/user-guide/features/memory)** — Persistent context across sessions
-   **[Tips & Best Practices](/docs/ko/docs/guides/tips)** — More prompt engineering advice
