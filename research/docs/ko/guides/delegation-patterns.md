...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/guides/delegation-patterns
...
For the full feature reference, see [Subagent Delegation](/docs/ko/docs/user-guide/features/delegation).
...
_For the complete delegation reference — all parameters, ACP integration, and advanced configuration — see [Subagent Delegation](/docs/ko/docs/user-guide/features/delegation)._
