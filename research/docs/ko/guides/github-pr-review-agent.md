...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/guides/github-pr-review-agent
...
If you have a public endpoint available, check out [Automated GitHub PR Comments with Webhooks](/docs/ko/guides/webhook-github-pr-review) — GitHub pushes events to Hermes instantly when PRs are opened or updated.

* * *

## Prerequisites

-   **Hermes Agent installed** — see the [Installation guide](/docs/ko/docs/getting-started/installation)
...
-   **Messaging configured** (optional) — [Telegram](/docs/ko/docs/user-guide/messaging/telegram) or [Discord](/docs/ko/docs/user-guide/messaging/discord)
...
-   **[Webhook-Based PR Reviews](/docs/ko/guides/webhook-github-pr-review)** — get instant reviews when PRs are opened (requires a public endpoint)
-   **[Daily Briefing Bot](/docs/ko/docs/guides/daily-briefing-bot)** — combine PR reviews with your morning news digest
-   **[Build a Plugin](/docs/ko/docs/guides/build-a-hermes-plugin)** — wrap the review logic into a shareable plugin
-   **[Profiles](/docs/ko/docs/user-guide/profiles)** — run a dedicated reviewer profile with its own memory and config
-   **[Fallback Providers](/docs/ko/docs/user-guide/features/fallback-providers)** — ensure reviews run even when one provider is down
