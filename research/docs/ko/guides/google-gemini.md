...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/guides/google-gemini
...
-   [AI Providers](/docs/ko/docs/integrations/providers)
-   [Configuration](/docs/ko/docs/user-guide/configuration)
-   [Fallback Providers](/docs/ko/docs/user-guide/features/fallback-providers)
-   [AWS Bedrock](/docs/ko/docs/guides/aws-bedrock) — native cloud-provider integration using AWS credentials
