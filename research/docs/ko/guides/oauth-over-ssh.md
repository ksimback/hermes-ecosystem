...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/guides/oauth-over-ssh
...
-   [xAI Grok OAuth](/docs/ko/guides/xai-grok-oauth)
-   [Spotify (`Running over SSH`)](/docs/ko/user-guide/features/spotify#running-over-ssh--in-a-headless-environment)
