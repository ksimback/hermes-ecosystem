...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/guides/operate-teams-meeting-pipeline

Use this guide after you have already enabled the feature from [Teams Meetings](/docs/ko/docs/user-guide/messaging/teams-meetings).
...
-   [Teams Meetings setup](/docs/ko/docs/user-guide/messaging/teams-meetings)
