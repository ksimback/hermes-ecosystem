...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/guides/pipe-script-output
...
-   [Automate Anything with Cron](/docs/ko/docs/guides/automate-with-cron) — scheduled jobs whose output auto-delivers to any platform.
-   [Gateway Internals](/docs/ko/docs/developer-guide/gateway-internals) — the delivery router that `hermes send` shares with cron delivery.
-   [Messaging Platform Setup](/docs/ko/docs/user-guide/messaging/) — one-time configuration for each platform.
