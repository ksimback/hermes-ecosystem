...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/guides/team-telegram-assistant
...
-   **Hermes Agent installed** on a server or VPS (not your laptop — the bot needs to stay running). Follow the [installation guide](/docs/ko/docs/getting-started/installation) if you haven't yet.
...
For a full guide, see [Use SOUL.md with Hermes](/docs/ko/docs/guides/use-soul-with-hermes).
...
-   **[Security Guide](/docs/ko/docs/user-guide/security)** — deep dive into authorization, container isolation, and command approval
-   **[Messaging Gateway](/docs/ko/docs/user-guide/messaging)** — full reference for gateway architecture, session management, and chat commands
-   **[Telegram Setup](/docs/ko/docs/user-guide/messaging/telegram)** — platform-specific details including voice messages and TTS
-   **[Scheduled Tasks](/docs/ko/docs/user-guide/features/cron)** — advanced cron scheduling with delivery options and cron expressions
-   **[Context Files](/docs/ko/docs/user-guide/features/context-files)** — AGENTS.md, SOUL.md, and .cursorrules for project knowledge
-   **[Personality](/docs/ko/docs/user-guide/features/personality)** — built-in personality presets and custom persona definitions
-   **Add more platforms** — the same gateway can simultaneously run [Discord](/docs/ko/docs/user-guide/messaging/discord), [Slack](/docs/ko/docs/user-guide/messaging/slack), and [WhatsApp](/docs/ko/docs/user-guide/messaging/whatsapp)
