...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/guides/tips
...
For a full walkthrough, see [Use SOUL.md with Hermes](/docs/ko/docs/guides/use-soul-with-hermes).
