...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/guides/use-voice-mode-with-hermes

This guide is the practical companion to the [Voice Mode feature reference](/docs/ko/docs/user-guide/features/voice-mode).
...
-   [Voice Mode feature reference](/docs/ko/docs/user-guide/features/voice-mode)
-   [Messaging Gateway](/docs/ko/docs/user-guide/messaging)
-   [Discord setup](/docs/ko/docs/user-guide/messaging/discord)
-   [Telegram setup](/docs/ko/docs/user-guide/messaging/telegram)
-   [Configuration](/docs/ko/docs/user-guide/configuration)
