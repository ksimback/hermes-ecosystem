...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/guides/work-with-skills
...
For the full technical reference, see [Skills System](/docs/ko/docs/user-guide/features/skills).
...
For how to ship skills in your own plugin, see [Build a Hermes Plugin → Bundle skills](/docs/ko/docs/guides/build-a-hermes-plugin#bundle-skills).
...
_For the complete skills reference — frontmatter fields, conditional activation, external directories, and more — see [Skills System](/docs/ko/docs/user-guide/features/skills)._
