...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/guides/xai-grok-oauth
...
See [OAuth over SSH / Remote Hosts](/docs/ko/guides/oauth-over-ssh) for the full step-by-step, including ProxyJump chains, mosh/tmux, and ControlMaster gotchas.
...
See [OAuth over SSH / Remote Hosts](/docs/ko/guides/oauth-over-ssh#browser-only-remote-cloud-shell--codespaces--ec2-instance-connect) for the full walkthrough. Regression fix for [#26923](https://github.com/NousResearch/hermes-agent/issues/26923).
...
Full walkthrough (jump boxes, mosh/tmux, port conflicts): [OAuth over SSH / Remote Hosts](/docs/ko/guides/oauth-over-ssh).
...
-   [OAuth over SSH / Remote Hosts](/docs/ko/guides/oauth-over-ssh) — required reading if Hermes is on a different machine than your browser
-   [AI Providers reference](/docs/ko/integrations/providers)
-   [Environment Variables](/docs/ko/reference/environment-variables)
-   [Configuration](/docs/ko/user-guide/configuration)
-   [Voice & TTS](/docs/ko/user-guide/features/tts)
