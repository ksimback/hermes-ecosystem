...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/
...
**Windows (native, PowerShell)** — _early beta, [details →](/docs/ko/docs/user-guide/windows-native)_
...
See the full **[Installation Guide](/docs/ko/docs/getting-started/installation)** for what the installer does, the per-user vs root layout, and Windows-specific notes.
...
🚀 **[Installation](/docs/ko/docs/getting-started/installation)**

Install in 60 seconds on Linux, macOS, WSL2, or native Windows (early beta)

📖 **[Quickstart Tutorial](/docs/ko/docs/getting-started/quickstart)**

Your first conversation and key features to try

🗺️ **[Learning Path](/docs/ko/docs/getting-started/learning-path)**

Find the right docs for your experience level

⚙️ **[Configuration](/docs/ko/docs/user-guide/configuration)**

Config file, providers, models, and options

💬 **[Messaging Gateway](/docs/ko/docs/user-guide/messaging)**

Set up Telegram, Discord, Slack, WhatsApp, Teams, or more

🔧 **[Tools & Toolsets](/docs/ko/docs/user-guide/features/tools)**

70+ built-in tools and how to configure them

🧠 **[Memory System](/docs/ko/docs/user-guide/features/memory)**

Persistent memory that grows across sessions

📚 **[Skills System](/docs/ko/docs/user-guide/features/skills)**

Procedural memory the agent creates and reuses

🔌 **[MCP Integration](/docs/ko/docs/user-guide/features/mcp)**
...
🎙️ **[Voice Mode](/docs/ko/docs/user-guide/features/voice-mode)**

Real-time voice interaction in CLI, Telegram, Discord, and Discord VC

🗣️ **[Use Voice Mode with Hermes](/docs/ko/docs/guides/use-voice-mode-with-hermes)**
...
🔒 **[Security](/docs/ko/docs/user-guide/security)**

Command approval, authorization, container isolation

💡 **[Tips & Best Practices](/docs/ko/docs/guides/tips)**

Quick wins to get the most out of Hermes

🏗️ **[Architecture](/docs/ko/docs/developer-guide/architecture)**

How it works under the hood

❓ **[FAQ & Troubleshooting](/docs/ko/docs/reference/faq)**
...
-   **[`/llms.txt`](/docs/ko/assets/files/llms-bcf65f79b33e57e6c0cce5b9627945d4.txt)** — curated index of every doc page with short descriptions. ~17 KB, safe to load into an LLM context.
-   **[`/llms-full.txt`](/docs/ko/assets/files/llms-full-5ef55acbcec1661a112fb6e77a7c5ea5.txt)** — every doc page concatenated into a single markdown file for one-shot ingestion. ~1.8 MB.
