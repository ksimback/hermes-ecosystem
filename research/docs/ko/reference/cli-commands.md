...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/reference/cli-commands

This page covers the **terminal commands** you run from your shell.

For in-chat slash commands, see [Slash Commands Reference](/docs/ko/reference/slash-commands).
...
Launch the [TUI](/docs/ko/user-guide/tui) instead of the classic CLI. Equivalent to `HERMES_TUI=1`.
...
Local OpenAI-compatible proxy that attaches OAuth provider credentials. See [Subscription Proxy](/docs/ko/user-guide/features/subscription-proxy).
...
Group several skills under a single `/<name>` slash command. See [Skill Bundles](/docs/ko/user-guide/features/skills#skill-bundles).

`hermes curator`

Background skill maintenance — status, run, pause, pin. See [Curator](/docs/ko/user-guide/features/curator).
...
Nous Portal status, subscription link, and Tool Gateway routing. See [Tool Gateway](/docs/ko/user-guide/features/tool-gateway).
...
Use `hermes gateway run` instead of `hermes gateway start` — WSL's systemd support is unreliable. Wrap it in tmux for persistence: `tmux new -s hermes 'hermes gateway run'`. See [WSL FAQ](/docs/ko/docs/reference/faq#wsl-gateway-keeps-disconnecting-or-hermes-gateway-start-fails) for details.
...
See [LSP — Semantic Diagnostics](/docs/ko/docs/user-guide/features/lsp) for the full guide, supported languages, and configuration knobs.
...
One-shot Nous Portal setup: log in via OAuth, set Nous as the inference provider, and opt into the [Tool Gateway](/docs/ko/user-guide/features/tool-gateway). Skips the rest of the wizard.
...
For configuration of the gateway itself, see [Tool Gateway](/docs/ko/user-guide/features/tool-gateway). For the one-shot setup path, see `hermes setup --portal` above.
...
Manage credential pools for same-provider key rotation. See [Credential Pools](/docs/ko/docs/user-guide/features/credential-pools) for full documentation.
...
For the full design — comparison with Cline Kanban / Paperclip / NanoClaw / Gemini Enterprise, eight collaboration patterns, four user stories, concurrency correctness proof — see `docs/hermes-kanban-v1-spec.pdf` in the repository or the [Kanban user guide](/docs/ko/docs/user-guide/features/kanban).
...
See [Checkpoints and `/rollback`](/docs/ko/user-guide/checkpoints-and-rollback) for the full architecture and the in-session commands.
...
Skill bundles group several skills under one `/<bundle-name>` slash command. Invoking the bundle loads every referenced skill into a single combined user message. Storage: `~/.hermes/skill-bundles/<slug>.yaml`. See [Skill Bundles](/docs/ko/user-guide/features/skills#skill-bundles) for the YAML schema and behavior.
...
See [Curator](/docs/ko/user-guide/features/curator) for behavior and config.
...
See [Fallback Providers](/docs/ko/user-guide/features/fallback-providers).
...
See [Hooks](/docs/ko/user-guide/features/hooks) for event signatures and payload shapes.
...
See [ACP Editor Integration](/docs/ko/user-guide/features/acp) and [ACP Internals](/docs/ko/developer-guide/acp-internals).
...
See [MCP Config Reference](/docs/ko/reference/mcp-config-reference), [Use MCP with Hermes](/docs/ko/guides/use-mcp-with-hermes), and [MCP Server Mode](/docs/ko/user-guide/features/mcp#running-hermes-as-an-mcp-server).
...
See [Plugins](/docs/ko/user-guide/features/plugins) and [Build a Hermes Plugin](/docs/ko/guides/build-a-hermes-plugin).
...
For the complete config key mapping, SecretRef handling details, and post-migration checklist, see the **[full migration guide](/docs/ko/guides/migrate-from-openclaw)**.
...
Launch the web dashboard — a browser-based UI for managing configuration, API keys, and monitoring sessions. Requires `pip install hermes-agent[web]` (FastAPI + Uvicorn). The embedded browser Chat tab requires `--tui` plus the `pty` extra. See [Web Dashboard](/docs/ko/docs/user-guide/features/web-dashboard) for full documentation.
...
-   [Slash Commands Reference](/docs/ko/reference/slash-commands)
-   [CLI Interface](/docs/ko/user-guide/cli)
-   [Sessions](/docs/ko/user-guide/sessions)
-   [Skills System](/docs/ko/user-guide/features/skills)
-   [Skins & Themes](/docs/ko/user-guide/features/skins)
