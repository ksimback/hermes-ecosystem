...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/reference/faq
...
Set your provider with `hermes model` or by editing `~/.hermes/.env`. See the [Environment Variables](/docs/ko/reference/environment-variables) reference for all provider keys.
...
-   [Use MCP with Hermes](/docs/ko/guides/use-mcp-with-hermes#wsl2-bridge-hermes-in-wsl-to-windows-chrome)
-   [Browser Automation](/docs/ko/user-guide/features/browser#wsl2--windows-chrome-prefer-mcp-over-browser-connect)
...
For the fully explicit manual steps, supported extras, and current limitations, see the [Termux guide](/docs/ko/getting-started/termux).
...
This works with Ollama, vLLM, llama.cpp server, SGLang, LocalAI, and others. See the [Configuration guide](/docs/ko/user-guide/configuration) for details.
...
Yes. The [messaging gateway](/docs/ko/user-guide/messaging/) lets multiple users interact with the same Hermes Agent instance via Telegram, Discord, Slack, WhatsApp, or Home Assistant. Access is controlled through allowlists (specific user IDs) and DM pairing (first user to message claims access).
...
Both persist across sessions. See [Memory](/docs/ko/user-guide/features/memory) and [Skills](/docs/ko/user-guide/features/skills) for details.
...
See the [Python Library guide](/docs/ko/user-guide/features/code-execution) for full API usage.
...
See [Context Length Detection](/docs/ko/integrations/providers#context-length-detection) for how auto-detection works and all override options.
...
-   See the full list of dangerous patterns in the [Security docs](/docs/ko/user-guide/security)
...
Configure in `~/.hermes/config.yaml` under your gateway's settings. See the [Messaging docs](/docs/ko/user-guide/messaging/).
...
-   [MCP (Model Context Protocol)](/docs/ko/docs/user-guide/features/mcp)
-   [Use MCP with Hermes](/docs/ko/docs/guides/use-mcp-with-hermes)
-   [MCP Config Reference](/docs/ko/docs/reference/mcp-config-reference)
...
See [Subagent Delegation](/docs/ko/user-guide/features/delegation) for more on how delegation works.
...
See [Profiles](/docs/ko/user-guide/profiles) and [WhatsApp setup](/docs/ko/user-guide/messaging/whatsapp) for more details.
