...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/reference/optional-skills-catalog
...
[**blackbox**](/docs/ko/docs/user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-blackbox)

Delegate coding tasks to Blackbox AI CLI agent. Multi-model agent with built-in judge that runs tasks through multiple LLMs and picks the best result. Requires the blackbox CLI and a Blackbox AI API key.

[**honcho**](/docs/ko/docs/user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-honcho)
...
[**evm**](/docs/ko/docs/user-guide/skills/optional/blockchain/blockchain-evm)

Read-only EVM client: wallets, tokens, gas across 8 chains.

[**hyperliquid**](/docs/ko/docs/user-guide/skills/optional/blockchain/blockchain-hyperliquid)

Hyperliquid market data, account history, trade review.

[**solana**](/docs/ko/docs/user-guide/skills/optional/blockchain/blockchain-solana)
...
[**one-three-one-rule**](/docs/ko/docs/user-guide/skills/optional/communication/communication-one-three-one-rule)
...
[**blender-mcp**](/docs/ko/docs/user-guide/skills/optional/creative/creative-blender-mcp)

Control Blender directly from Hermes via socket connection to the blender-mcp addon. Create 3D objects, materials, animations, and run arbitrary Blender Python (bpy) code. Use when user wants to create or modify anything in Blender.

[**concept-diagrams**](/docs/ko/docs/user-guide/skills/optional/creative/creative-concept-diagrams)
...
[**hyperframes**](/docs/ko/docs/user-guide/skills/optional/creative/creative-hyperframes)
...
[**kanban-video-orchestrator**](/docs/ko/docs/user-guide/skills/optional/creative/creative-kanban-video-orchestrator)
...
[**meme-generation**](/docs/ko/docs/user-guide/skills/optional/creative/creative-meme-generation)
...
[**inference-sh-cli**](/docs/ko/docs/user-guide/skills/optional/devops/devops-cli)
...
[**docker-management**](/docs/ko/docs/user-guide/skills/optional/devops/devops-docker-management)

Manage Docker containers, images, volumes, networks, and Compose stacks — lifecycle ops, debugging, cleanup, and Dockerfile optimization.

[**pinggy-tunnel**](/docs/ko/docs/user-guide/skills/optional/devops/devops-pinggy-tunnel)

Zero-install localhost tunnels over SSH via Pinggy.

[**watchers**](/docs/ko/docs/user-guide/skills/optional/devops/devops-watchers)
...
[**adversarial-ux-test**](/docs/ko/docs/user-guide/skills/optional/dogfood/dogfood-adversarial-ux-test)
...
[**agentmail**](/docs/ko/docs/user-guide/skills/optional/email/email-agentmail)
...
[**3-statement-model**](/docs/ko/docs/user-guide/skills/optional/finance/finance-3-statement-model)
...
[**comps-analysis**](/docs/ko/docs/user-guide/skills/optional/finance/finance-comps-analysis)
...
[**dcf-model**](/docs/ko/docs/user-guide/skills/optional/finance/finance-dcf-model)
...
[**excel-author**](/docs/ko/docs/user-guide/skills/optional/finance/finance-excel-author)
...
[**lbo-model**](/docs/ko/docs/user-guide/skills/optional/finance/finance-lbo-model)
...
[**merger-model**](/docs/ko/docs/user-guide/skills/optional/finance/finance-merger-model)
...
[**pptx-author**](/docs/ko/docs/user-guide/skills/optional/finance/finance-pptx-author)
...
[**stocks**](/docs/ko/docs/user-guide/skills/optional/finance/finance-stocks)
...
[**fitness-nutrition**](/docs/ko/docs/user-guide/skills/optional/health/health-fitness-nutrition)
...
[**neuroskill-bci**](/docs/ko/docs/user-guide/skills/optional/health/health-neuroskill-bci)
...
[**fastmcp**](/docs/ko/docs/user-guide/skills/optional/mcp/mcp-fastmcp)
...
[**mcporter**](/docs/ko/docs/user-guide/skills/optional/mcp/mcp-mcporter)
...
[**openclaw-migration**](/docs/ko/docs/user-guide/skills/optional/migration/migration-openclaw-migration)
...
[**huggingface-accelerate**](/docs/ko/docs/user-guide/skills/optional/mlops/mlops-accelerate)
...
[**axolotl**](/docs/ko/docs/user-guide/skills/optional/mlops/mlops-training-axolotl)

Axolotl: YAML LLM fine-tuning (LoRA, DPO, GRPO).

[**chroma**](/docs/ko/docs/user-guide/skills/optional/mlops/mlops-chroma)
...
[**clip**](/docs/ko/docs/user-guide/skills/optional/mlops/mlops-clip)
...
[**faiss**](/docs/ko/docs/user-guide/skills/optional/mlops/mlops-faiss)
...
[**optimizing-attention-flash**](/docs/ko/docs/user-guide/skills/optional/mlops/mlops-flash-attention)
...
[**guidance**](/docs/ko/docs/user-guide/skills/optional/mlops/mlops-guidance)

Control LLM output with regex and grammars, guarantee valid JSON/XML/code generation, enforce structured formats, and build multi-step workflows with Guidance - Microsoft Research's constrained generation framework

[**huggingface-tokenizers**](/docs/ko/docs/user-guide/skills/optional/mlops/mlops-huggingface-tokenizers)
...
[**instructor**](/docs/ko/docs/user-guide/skills/optional/mlops/mlops-instructor)

Extract structured data from LLM responses with Pydantic validation, retry failed extractions automatically, parse complex JSON with type safety, and stream partial results with Instructor - battle-tested structured output library

[**lambda-labs-gpu-cloud**](/docs/ko/docs/user-guide/skills/optional/mlops/mlops-lambda-labs)

Reserved and on-demand GPU cloud instances for ML training and inference. Use when you need dedicated GPU instances with simple SSH access, persistent filesystems, or high-performance multi-node clusters for large-scale training.

[**llava**](/docs/ko/docs/user-guide/skills/optional/mlops/mlops-llava)
...
[**modal-serverless-gpu**](/docs/ko/docs/user-guide/skills/optional/mlops/mlops-modal)

Serverless GPU cloud platform for running ML workloads. Use when you need on-demand GPU access without infrastructure management, deploying ML models as APIs, or running batch jobs with automatic scaling.

[**nemo-curator**](/docs/ko/docs/user-guide/skills/optional/mlops/mlops-nemo-curator)
...
[**outlines**](/docs/ko/docs/user-guide/skills/optional/mlops/mlops-inference-outlines)

Outlines: structured JSON/regex/Pydantic LLM generation.

[**peft-fine-tuning**](/docs/ko/docs/user-guide/skills/optional/mlops/mlops-peft)
...
[**pinecone**](/docs/ko/docs/user-guide/skills/optional/mlops/mlops-pinecone)
...
[**pytorch-fsdp**](/docs/ko/docs/user-guide/skills/optional/mlops/mlops-pytorch-fsdp)

Expert guidance for Fully Sharded Data Parallel training with PyTorch FSDP - parameter sharding, mixed precision, CPU offloading, FSDP2

[**pytorch-lightning**](/docs/ko/docs/user-guide/skills/optional/mlops/mlops-pytorch-lightning)
...
[**qdrant-vector-search**](/docs/ko/docs/user-guide/skills/optional/mlops/mlops-qdrant)
...
[**sparse-autoencoder-training**](/docs/ko/docs/user-guide/skills/optional/mlops/mlops-saelens)
...
[**simpo-training**](/docs/ko/docs/user-guide/skills/optional/mlops/mlops-simpo)
...
[**slime-rl-training**](/docs/ko/docs/user-guide/skills/optional/mlops/mlops-slime)

Provides guidance for LLM post-training with RL using slime, a Megatron+SGLang framework. Use when training GLM models, implementing custom data generation workflows, or needing tight Megatron-LM integration for RL scaling.

[**stable-diffusion-image-generation**](/docs/ko/docs/user-guide/skills/optional/mlops/mlops-stable-diffusion)

State-of-the-art text-to-image generation with Stable Diffusion models via HuggingFace Diffusers. Use when generating images from text prompts, performing image-to-image translation, inpainting, or building custom diffusion pipelines.

[**tensorrt-llm**](/docs/ko/docs/user-guide/skills/optional/mlops/mlops-tensorrt-llm)
...
[**distributed-llm-pretraining-torchtitan**](/docs/ko/docs/user-guide/skills/optional/mlops/mlops-torchtitan)
...
[**fine-tuning-with-trl**](/docs/ko/docs/user-guide/skills/optional/mlops/mlops-training-trl-fine-tuning)

TRL: SFT, DPO, PPO, GRPO, reward modeling for LLM RLHF.

[**unsloth**](/docs/ko/docs/user-guide/skills/optional/mlops/mlops-training-unsloth)

Unsloth: 2-5x faster LoRA/QLoRA fine-tuning, less VRAM.

[**whisper**](/docs/ko/docs/user-guide/skills/optional/mlops/mlops-whisper)
...
[**canvas**](/docs/ko/docs/user-guide/skills/optional/productivity/productivity-canvas)

Canvas LMS integration — fetch enrolled courses and assignments using API token authentication.

[**here.now**](/docs/ko/docs/user-guide/skills/optional/productivity/productivity-here-now)

Publish static sites to {slug}.here.now and store private files in cloud Drives for agent-to-agent handoff.

[**memento-flashcards**](/docs/ko/docs/user-guide/skills/optional/productivity/productivity-memento-flashcards)
...
[**shop-app**](/docs/ko/docs/user-guide/skills/optional/productivity/productivity-shop-app)

Shop.app: product search, order tracking, returns, reorder.

[**shopify**](/docs/ko/docs/user-guide/skills/optional/productivity/productivity-shopify)

Shopify Admin & Storefront GraphQL APIs via curl. Products, orders, customers, inventory, metafields.

[**siyuan**](/docs/ko/docs/user-guide/skills/optional/productivity/productivity-siyuan)
...
[**telephony**](/docs/ko/docs/user-guide/skills/optional/productivity/productivity-telephony)
...
[**bioinformatics**](/docs/ko/docs/user-guide/skills/optional/research/research-bioinformatics)
...
[**darwinian-evolver**](/docs/ko/docs/user-guide/skills/optional/research/research-darwinian-evolver)

Evolve prompts/regex/SQL/code with Imbue's evolution loop.

[**domain-intel**](/docs/ko/docs/user-guide/skills/optional/research/research-domain-intel)
...
[**drug-discovery**](/docs/ko/docs/user-guide/skills/optional/research/research-drug-discovery)
...
[**duckduckgo-search**](/docs/ko/docs/user-guide/skills/optional/research/research-duckduckgo-search)
...
[**gitnexus-explorer**](/docs/ko/docs/user-guide/skills/optional/research/research-gitnexus-explorer)

Index a codebase with GitNexus and serve an interactive knowledge graph via web UI + Cloudflare tunnel.

[**osint-investigation**](/docs/ko/docs/user-guide/skills/optional/research/research-osint-investigation)
...
[**parallel-cli**](/docs/ko/docs/user-guide/skills/optional/research/research-parallel-cli)
...
[**qmd**](/docs/ko/docs/user-guide/skills/optional/research/research-qmd)
...
[**scrapling**](/docs/ko/docs/user-guide/skills/optional/research/research-scrapling)
...
[**searxng-search**](/docs/ko/docs/user-guide/skills/optional/research/research-searxng-search)
...
[**1password**](/docs/ko/docs/user-guide/skills/optional/security/security-1password)

Set up and use 1Password CLI (op). Use when installing the CLI, enabling desktop app integration, signing in, and reading/injecting secrets for commands.

[**oss-forensics**](/docs/ko/docs/user-guide/skills/optional/security/security-oss-forensics)
...
[**sherlock**](/docs/ko/docs/user-guide/skills/optional/security/security-sherlock)
...
[**rest-graphql-debug**](/docs/ko/docs/user-guide/skills/optional/software-development/software-development-rest-graphql-debug)
...
[**page-agent**](/docs/ko/docs/user-guide/skills/optional/web-development/web-development-page-agent)
