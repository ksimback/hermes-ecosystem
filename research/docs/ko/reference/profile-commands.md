...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/reference/profile-commands

This page covers all commands related to [Hermes profiles](/docs/ko/user-guide/profiles). For general CLI commands, see [CLI Commands Reference](/docs/ko/reference/cli-commands).
...
Install a profile distribution from a git URL or local directory. See [Profile Distributions](/docs/ko/user-guide/profile-distributions).
...
**New to distributions?** Start with the [Profile Distributions user guide](/docs/ko/user-guide/profile-distributions) — it covers the why, when, and how with full examples. The sections below are a dry CLI reference for when you know what you want.
...
-   [Profiles User Guide](/docs/ko/user-guide/profiles)
-   [CLI Commands Reference](/docs/ko/reference/cli-commands)
-   [FAQ — Profiles section](/docs/ko/reference/faq#profiles)
