...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/checkpoints-and-rollback
...
For running multiple agents in parallel on the same repo, see the guide on [Git worktrees](/docs/ko/user-guide/git-worktrees).
