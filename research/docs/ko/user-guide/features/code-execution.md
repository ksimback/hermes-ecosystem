...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/features/code-execution
...
See the [Security guide](/docs/ko/docs/user-guide/security#environment-variable-passthrough) for full details.
...
⚠️ Only via [passthrough](/docs/ko/docs/user-guide/security#environment-variable-passthrough)
