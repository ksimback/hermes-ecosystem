...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/features/context-files
...
`SOUL.md` controls the agent's personality, tone, and communication style. See the [Personality](/docs/ko/docs/user-guide/features/personality) page for full details.
