...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/features/cron
...
See the [Script-Only Cron Jobs guide](/docs/ko/docs/guides/cron-script-only) for worked examples.
...
-   **Rotate to the next credential** in your [credential pool](/docs/ko/docs/user-guide/configuration#credential-pool-strategies) for the same provider
