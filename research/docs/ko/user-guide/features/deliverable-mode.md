...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/features/deliverable-mode
...
Install MCP servers via `~/.hermes/config.yaml` under the `mcp_servers` section. See [MCP integration](/docs/ko/user-guide/features/mcp) for the full setup guide.
