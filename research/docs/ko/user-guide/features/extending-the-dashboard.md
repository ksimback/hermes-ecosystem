...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/features/extending-the-dashboard
...
If you just want to use the dashboard, see [Web Dashboard](/docs/ko/user-guide/features/web-dashboard). If you want to reskin the terminal CLI (not the web dashboard), see [Skins & Themes](/docs/ko/user-guide/features/skins) — the CLI skin system is unrelated to dashboard themes.
...
-   `plugin.yaml` + `__init__.py` — CLI/gateway plugin ([see plugins page](/docs/ko/user-guide/features/plugins)).
...
See [Web Dashboard → REST API](/docs/ko/user-guide/features/web-dashboard#rest-api) for the full list.
