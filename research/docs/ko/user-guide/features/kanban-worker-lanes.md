...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/features/kanban-worker-lanes
...
-   [Kanban overview](/docs/ko/user-guide/features/kanban) — the user-facing intro.
-   [Kanban tutorial](/docs/ko/user-guide/features/kanban-tutorial) — walkthrough with the dashboard open.
