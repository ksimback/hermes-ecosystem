...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/features/memory-providers
...
See the [Honcho page](/docs/ko/user-guide/features/honcho#observation-directional-vs-unified) for the full observation reference.
...
Each provider's data is isolated per [profile](/docs/ko/docs/user-guide/profiles):
...
See the [Developer Guide: Memory Provider Plugins](/docs/ko/docs/developer-guide/memory-provider-plugin) for how to create your own.
