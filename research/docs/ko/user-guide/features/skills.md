...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/features/skills
...
-   [Bundled Skills Catalog](/docs/ko/docs/reference/skills-catalog)
-   [Official Optional Skills Catalog](/docs/ko/docs/reference/optional-skills-catalog)
...
Once set, declared env vars are **automatically passed through** to `execute_code` and `terminal` sandboxes — the skill's scripts can use `$TENOR_API_KEY` directly. For non-skill env vars, use the `terminal.env_passthrough` config option. See [Environment Variable Passthrough](/docs/ko/docs/user-guide/security#environment-variable-passthrough) for details.
...
See [Skill Settings](/docs/ko/docs/user-guide/configuration#skill-settings) and [Creating Skills — Config Settings](/docs/ko/docs/developer-guide/creating-skills#config-settings-configyaml) for details.
...
-   Catalog: [Official Optional Skills Catalog](/docs/ko/reference/optional-skills-catalog)
