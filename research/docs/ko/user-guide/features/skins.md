...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/features/skins
...
Hermes Mod respects the `HERMES_HOME` environment variable, so it works with [profiles](/docs/ko/docs/user-guide/profiles) too.
