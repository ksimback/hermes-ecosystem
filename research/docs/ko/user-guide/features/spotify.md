...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/features/spotify
...
For jump-box / bastion setups and other gotchas (mosh, tmux, port conflicts), see [OAuth over SSH / Remote Hosts](/docs/ko/guides/oauth-over-ssh).
...
Full cron reference: [Cron Jobs](/docs/ko/user-guide/features/cron).
