...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/features/subscription-proxy
...
This is different from the [API server](/docs/ko/user-guide/features/api-server):
