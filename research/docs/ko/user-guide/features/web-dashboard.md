...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/features/web-dashboard
...
To build your own theme, add a plugin tab, inject into shell slots, or expose plugin-specific REST endpoints, see **[Extending the Dashboard](/docs/ko/user-guide/features/extending-the-dashboard)** — the complete guide covers:
