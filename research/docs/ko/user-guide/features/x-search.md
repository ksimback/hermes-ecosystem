...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/features/x-search
...
`hermes auth add xai-oauth` — see [xAI Grok OAuth (SuperGrok / X Premium+)](/docs/ko/guides/xai-grok-oauth)
...
-   [xAI Grok OAuth (SuperGrok / Premium+)](/docs/ko/guides/xai-grok-oauth) — the OAuth setup guide
-   [Web Search & Extract](/docs/ko/user-guide/features/web-search) — for general (non-X) web search
-   [Tools Reference](/docs/ko/reference/tools-reference) — full tool catalog
