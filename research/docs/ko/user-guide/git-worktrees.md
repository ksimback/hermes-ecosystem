...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/git-worktrees
...
See also: [Checkpoints and /rollback](/docs/ko/user-guide/checkpoints-and-rollback).
...
-   **Commit frequently**
    ...
    -   Use [checkpoints and /rollback](/docs/ko/user-guide/checkpoints-and-rollback) as a safety net for tool‑driven edits in between.
