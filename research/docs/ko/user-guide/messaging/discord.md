...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/messaging/discord
...
-   [Voice Mode](/docs/ko/docs/user-guide/features/voice-mode)
-   [Use Voice Mode with Hermes](/docs/ko/docs/guides/use-voice-mode-with-hermes)
