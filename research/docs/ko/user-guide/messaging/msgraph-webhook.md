...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/messaging/msgraph-webhook
...
-   Microsoft Graph application credentials — [Register a Microsoft Graph Application](/docs/ko/docs/guides/microsoft-graph-app-registration)
...
Each setting also has an equivalent env var (`MSGRAPH_WEBHOOK_*`) that merges into the config at gateway startup — see the [environment variables reference](/docs/ko/docs/reference/environment-variables#microsoft-graph-teams-meetings).
...
-   [Register a Microsoft Graph Application](/docs/ko/docs/guides/microsoft-graph-app-registration) — Azure app registration prereq
-   [Environment Variables → Microsoft Graph](/docs/ko/docs/reference/environment-variables#microsoft-graph-teams-meetings) — full env var list
-   [Microsoft Teams bot setup](/docs/ko/docs/user-guide/messaging/teams) — the different platform that lets users chat with Hermes in Teams
