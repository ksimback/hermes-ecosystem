...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/messaging/telegram
...
For more details, see the [Security documentation](/docs/ko/user-guide/security). You can also use [DM pairing](/docs/ko/user-guide/messaging#dm-pairing-alternative-to-allowlists) for a more dynamic approach to user authorization.
