...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/messaging/wecom-callback
...
-   **[WeCom Bot](/docs/ko/user-guide/messaging/wecom)** — bot-style, connects via WebSocket. Simpler setup, works in group chats.
