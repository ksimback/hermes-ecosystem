...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/messaging/weixin
...
This adapter is for **personal WeChat accounts** (微信). If you need enterprise/corporate WeChat, see the [WeCom adapter](/docs/ko/user-guide/messaging/wecom) instead.
