...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/profile-distributions
...
If a [profile](/docs/ko/user-guide/profiles) is a local agent, a distribution is that agent made shareable.
...
-   **You just want to back up a profile on your own machine.** Use [`hermes profile export` / `import`](/docs/ko/reference/profile-commands#hermes-profile-export) — that's what those are for.
...
For implementation details, precise CLI behavior, and all flags, see the [Profile Commands reference](/docs/ko/reference/profile-commands#distribution-commands).
...
-   [Profiles: Running Multiple Agents](/docs/ko/user-guide/profiles) — the base concept
-   [Profile Commands reference](/docs/ko/reference/profile-commands) — every flag, every option
-   [`hermes profile export` / `import`](/docs/ko/reference/profile-commands#hermes-profile-export) — local backup / restore (not distribution)
-   [Using SOUL with Hermes](/docs/ko/guides/use-soul-with-hermes) — authoring personalities
-   [Personality & SOUL](/docs/ko/user-guide/features/personality) — how SOUL fits into the agent
-   [Skills catalog](/docs/ko/reference/skills-catalog) — skills you can bundle
