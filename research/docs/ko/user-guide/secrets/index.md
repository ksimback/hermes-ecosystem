...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/secrets/
...
-   [Bitwarden Secrets Manager](/docs/ko/user-guide/secrets/bitwarden) — `bws` CLI, lazy-installed, free tier works.
