...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/sessions
...
For deeper analytics — token usage, cost estimates, tool breakdown, and activity patterns — use [`hermes insights`](/docs/ko/docs/reference/cli-commands#hermes-insights).
