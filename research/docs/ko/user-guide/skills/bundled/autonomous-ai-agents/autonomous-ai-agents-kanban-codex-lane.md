...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-kanban-codex-lane
...
`skills/autonomous-ai-agents/kanban-codex-lane`
...
`kanban`, `codex`, `worktrees`, `autonomous-agents`, `prediction-market-bot`

Related skills

[`kanban-worker`](/docs/ko/docs/user-guide/skills/bundled/devops/devops-kanban-worker), [`codex`](/docs/ko/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-codex), [`hermes-agent`](/docs/ko/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-hermes-agent)
...
## kanban\_complete Metadata Schema
