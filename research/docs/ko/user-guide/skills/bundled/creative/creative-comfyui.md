...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/skills/bundled/creative/creative-comfyui
...
[`stable-diffusion-image-generation`](/docs/ko/docs/user-guide/skills/optional/mlops/mlops-stable-diffusion), `image_gen`
