...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/skills/bundled/creative/creative-sketch
...
[`spike`](/docs/ko/docs/user-guide/skills/bundled/software-development/software-development-spike), [`claude-design`](/docs/ko/docs/user-guide/skills/bundled/creative/creative-claude-design), [`popular-web-designs`](/docs/ko/docs/user-guide/skills/bundled/creative/creative-popular-web-designs), [`excalidraw`](/docs/ko/docs/user-guide/skills/bundled/creative/creative-excalidraw)
