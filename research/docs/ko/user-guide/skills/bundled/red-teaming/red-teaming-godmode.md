...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/skills/bundled/red-teaming/red-teaming-godmode
...
[`obliteratus`](/docs/ko/docs/user-guide/skills/bundled/mlops/mlops-inference-obliteratus)
