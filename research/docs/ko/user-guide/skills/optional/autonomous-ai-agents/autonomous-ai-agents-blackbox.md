...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-blackbox
...
[`claude-code`](/docs/ko/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-claude-code), [`codex`](/docs/ko/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-codex), [`hermes-agent`](/docs/ko/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-hermes-agent)
