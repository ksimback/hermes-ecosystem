...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/skills/optional/creative/creative-kanban-video-orchestrator
...
[`kanban-orchestrator`](/docs/ko/docs/user-guide/skills/bundled/devops/devops-kanban-orchestrator), [`kanban-worker`](/docs/ko/docs/user-guide/skills/bundled/devops/devops-kanban-worker), [`ascii-video`](/docs/ko/docs/user-guide/skills/bundled/creative/creative-ascii-video), [`manim-video`](/docs/ko/docs/user-guide/skills/bundled/creative/creative-manim-video), [`p5js`](/docs/ko/docs/user-guide/skills/bundled/creative/creative-p5js), [`comfyui`](/docs/ko/docs/user-guide/skills/bundled/creative/creative-comfyui), [`touchdesigner-mcp`](/docs/ko/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp), [`blender-mcp`](/docs/ko/docs/user-guide/skills/optional/creative/creative-blender-mcp), [`pixel-art`](/docs/ko/docs/user-guide/skills/bundled/creative/creative-pixel-art), [`ascii-art`](/docs/ko/docs/user-guide/skills/bundled/creative/creative-ascii-art), [`songwriting-and-ai-music`](/docs/ko/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music), [`heartmula`](/docs/ko/docs/user-guide/skills/bundled/media/media-heartmula), [`songsee`](/docs/ko/docs/user-guide/skills/bundled/media/media-songsee), [`spotify`](/docs/ko/docs/user-guide/skills/bundled/media/media-spotify), [`youtube-content`](/docs/ko/docs/user-guide/skills/bundled/media/media-youtube-content), [`claude-design`](/docs/ko/docs/user-guide/skills/bundled/creative/creative-claude-design), [`excalidraw`](/docs/ko/docs/user-guide/skills/bundled/creative/creative-excalidraw), [`architecture-diagram`](/docs/ko/docs/user-guide/skills/bundled/creative/creative-architecture-diagram), [`concept-diagrams`](/docs/ko/docs/user-guide/skills/optional/creative/creative-concept-diagrams), [`baoyu-comic`](/docs/ko/docs/user-guide/skills/bundled/creative/creative-baoyu-comic), [`baoyu-infographic`](/docs/ko/docs/user-guide/skills/bundled/creative/creative-baoyu-infographic), [`humanizer`](/docs/ko/docs/user-guide/skills/bundled/creative/creative-humanizer), [`gif-search`](/docs/ko/docs/user-guide/skills/bundled/media/media-gif-search), [`meme-generation`](/docs/ko/docs/user-guide/skills/optional/creative/creative-meme-generation)
