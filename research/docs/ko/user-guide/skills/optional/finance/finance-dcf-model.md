...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/skills/optional/finance/finance-dcf-model
...
[`excel-author`](/docs/ko/docs/user-guide/skills/optional/finance/finance-excel-author), [`pptx-author`](/docs/ko/docs/user-guide/skills/optional/finance/finance-pptx-author), [`comps-analysis`](/docs/ko/docs/user-guide/skills/optional/finance/finance-comps-analysis), [`lbo-model`](/docs/ko/docs/user-guide/skills/optional/finance/finance-lbo-model), [`3-statement-model`](/docs/ko/docs/user-guide/skills/optional/finance/finance-3-statement-model)
