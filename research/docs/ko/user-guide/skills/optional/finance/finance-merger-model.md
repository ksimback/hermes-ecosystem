...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/skills/optional/finance/finance-merger-model
...
[`excel-author`](/docs/ko/docs/user-guide/skills/optional/finance/finance-excel-author), [`pptx-author`](/docs/ko/docs/user-guide/skills/optional/finance/finance-pptx-author), [`dcf-model`](/docs/ko/docs/user-guide/skills/optional/finance/finance-dcf-model), [`3-statement-model`](/docs/ko/docs/user-guide/skills/optional/finance/finance-3-statement-model)
