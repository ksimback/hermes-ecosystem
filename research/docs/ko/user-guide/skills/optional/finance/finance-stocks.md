...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/skills/optional/finance/finance-stocks
...
[`dcf-model`](/docs/ko/docs/user-guide/skills/optional/finance/finance-dcf-model), [`comps-analysis`](/docs/ko/docs/user-guide/skills/optional/finance/finance-comps-analysis), [`lbo-model`](/docs/ko/docs/user-guide/skills/optional/finance/finance-lbo-model)
