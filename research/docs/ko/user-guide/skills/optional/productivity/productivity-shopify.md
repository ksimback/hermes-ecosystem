...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/skills/optional/productivity/productivity-shopify
...
[`airtable`](/docs/ko/docs/user-guide/skills/bundled/productivity/productivity-airtable), [`xurl`](/docs/ko/docs/user-guide/skills/bundled/social-media/social-media-xurl)
