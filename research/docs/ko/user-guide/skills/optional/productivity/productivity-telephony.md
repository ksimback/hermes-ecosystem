...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/skills/optional/productivity/productivity-telephony
...
[`maps`](/docs/ko/docs/user-guide/skills/bundled/productivity/productivity-maps), [`google-workspace`](/docs/ko/docs/user-guide/skills/bundled/productivity/productivity-google-workspace), [`agentmail`](/docs/ko/docs/user-guide/skills/optional/email/email-agentmail)
