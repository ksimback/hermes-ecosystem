...
**Source:** https://hermes-agent.nousresearch.com/docs/ko/user-guide/skills/optional/research/research-qmd
...
[`obsidian`](/docs/ko/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`native-mcp`](/docs/ko/docs/user-guide/skills/bundled/mcp/mcp-native-mcp), [`arxiv`](/docs/ko/docs/user-guide/skills/bundled/research/research-arxiv)
